...
import SmileIcon from "../../public/icons/svgs/SmileIcon";
import MobileIcon from "../../public/icons/svgs/MobileIcon";
...
export const menuItems: menuItems_T[] = [
  { title: "تجربه های سفر", target: "", _id: "143", Icon: SmileIcon },
  { title: "برنامه ریزی سفر", target: "", _id: "123", Icon: CalendarIcon },
  { title: "ایران شناسی", target: "", _id: "112", Icon: MapIcon },
  { title: "مقالات گردشگری", target: "", _id: "133", Icon: DucomentIcon },
];
