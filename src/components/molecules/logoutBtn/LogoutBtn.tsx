    ...
    <>
      ...
      isClickable
       effect="ease_out"
        ...
        {/* picture */}
        <div className=" w-[143px] sm:w-[333px] mx-auto 
        ...
        <Image
          ...
          {/* title */}
           <h2 className="w-full max-w-[289px] mx-auto text-center md:mt-[72px] mt-[52px]
            text-natural-black md:text-h2Semi 
             text-bodyB2semi   ">
              واقعا از حساب کاربری خودت 
              میخوای خارج بشی؟
             </h2>
        </div>
        {/* btn group */}
        <div className="flex items-center gap-x-14
         ...
         child:border-2 child:border-natural-gray3">
          <MainBtn onClick={close} variant="fill" size="xxl" state="hover">خیر</MainBtn>
          <MainBtn variant="fill" size="xxl" state="hover">بله</MainBtn>
        </div>
        </MainModal.Body>
      </MainModal>
    </>
